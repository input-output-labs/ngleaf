...
export function emailingReducer(reducerState, action): EmailingState {
  return createReducer(
    ...
    /** Categories */
    on(actions.setEmailingCategoriesCall, (state: EmailingState, {call}) => ({...state, categories: createAsyncTypeFromCall(call)})),
    ...
    /** Category actions */
    on(actions.setEmailingCategoryActionCall, (state: EmailingState, {call}) => ({...state, categoryAction: createAsyncTypeFromCall(call)})),
    ...
    /** Test email batch */
    on(actions.setTestEmailBatchCall, (state: EmailingState, {call}) => ({...state, testEmailBatch: createAsyncTypeFromCall(call)})),
    ...
    /** Email batch */
    on(actions.setEmailBatchCall, (state: EmailingState, {call}) => ({...state, emailBatch: createAsyncTypeFromCall(call)})),
